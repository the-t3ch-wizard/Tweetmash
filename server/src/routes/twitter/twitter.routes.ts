...
import { validateTweetParams } from "../../middlewares/validateTweetParams.middleware";
...
twitterRoutes.post("/schedule-tweet", asyncHandler(checkTweetLimit), asyncHandler(validateTweetParams), asyncHandler(twitter.scheduleTweet))
